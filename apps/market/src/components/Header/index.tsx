...
import { FiSearch, FiShoppingCart, FiAlignJustify, FiX } from 'react-icons/fi';
...
const Header = () => {
	...
	return (
		<div className="bg-white" style={{ minWidth: '1024px' }}>
			{/* Mobile menu */}
								...
								<div className="ml-4 flow-root lg:ml-6">
									<a href="#" className="group  flex items-center p-2">
										<button type="button" className="relative inline-flex items-center text-sm font-medium text-center text-white rounded-lg">
											<FiShoppingCart className="h-6 w-6 flex-shrink-0 text-gray-400 group-hover:text-gray-500" aria-hidden="true" />
